  ...
  questionList: [
    {
      ...
      content: '쿠키와 세션의 차이는?',
      answer:
        '- 쿠키는 브라우저에 키와 값으로 저장되는 작은 텍스트 파일이다. 쿠키는 주로 사용자의 상태 정보를 브라우저에 저장했다가 http 요청할 때마다 쿠키를 보내서 사용자를 인증하는데 사용한다. <br/> - 세션은 브라우저가 종료되기 전까지 클라이언트의 요청을 유지하게 해주는 기술이다. 세션의 내용은 서버에 저장되기 때문에 서버에 부하를 줄 수 있다.',
      submitcount: 0,
      category: 'web',
    },
    {
      ...
      answer: `- 추상화 : 객체의 공통 속성을 정의하는 것<br/>
        - 캡슐화 : 실제 구현 내부를 외부에 감추는 것<br/>
        - 상속 : 상위 객체의 속성을 하위 객체에서 사용할 수 있는 것<br/>
